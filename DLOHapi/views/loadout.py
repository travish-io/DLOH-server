...
from rest_framework import status
from DLOHapi.models import DlohUser, Loadout, LoadoutInv, dloh_user, loadout
...
class LoadoutView(ViewSet):
    ...
    def update(self, request, pk=None):
        ...
        loadout = Loadout.objects.get(pk=pk)
        loadout.name = request.data["name"]
        loadout.dloh_user = dloh_user
        loadout.save()
    ...
    def destroy(self, request, pk=None):
        """Handle DELETE requests for a single loadout
...
class LoadoutSerializer(serializers.ModelSerializer):
 ...
 # TO DO: refactor this signup method to add items to destiny_items_list for create method
    # actually this was not needed to create loadouts. might be useful for something else.
    #
